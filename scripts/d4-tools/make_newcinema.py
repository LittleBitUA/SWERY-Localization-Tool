...
TTF = r"F:/My.ttf"
OUT_DIR = Path(r"C:/Users/bidlov/AppData/Local/Temp/d4_font_test/newcinema_UA")
OUT_DIR.mkdir(parents=True, exist_ok=True)
ATLAS_W, ATLAS_H = 512, 512
FONT_SIZE = 36   # робоча версія
PAD = 2

def latin():
    return list(range(0x20, 0x7F)) + list(range(0xA0, 0x100))
...
def main():
    ...
    (OUT_DIR / "newcinema_meta.json").write_text(
