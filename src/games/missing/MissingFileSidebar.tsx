    ...
    <aside className="w-[280px] shrink-0 border-r border-[var(--border-soft)] flex flex-col min-h-0">
      <div className="px-2.5 py-2 border-b border-[var(--border-soft)] flex flex-col gap-1.5">
        ...
        <div className="flex gap-1 text-[10px]">
          <TabBtn active={tab === "all"} onClick={() => setTab("all")}>{t("sidebar.tab.all")} <span className="text-[var(--text-faint)]">{counts.all}</span></TabBtn>
          <TabBtn active={tab === "incomplete"} onClick={() => setTab("incomplete")}>{t("sidebar.tab.incomplete")} <span className="text-[var(--text-faint)]">{counts.incomplete}</span></TabBtn>
          <TabBtn active={tab === "complete"} onClick={() => setTab("complete")}>{t("sidebar.tab.complete")} <span className="text-[var(--text-faint)]">{counts.complete}</span></TabBtn>
        </div>
        <div className="flex items-center gap-1.5 text-[10px] text-[var(--text-faint)]">
          ...
          >
            ...
            <option value="percent">{t("sidebar.sort.percent")}</option>
            <option value="size">{t("sidebar.sort.size")}</option>
          </select>
